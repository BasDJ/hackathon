...
# --- STREAMLIT CONFIG ---
st.set_page_config(page_title="Ocean Health Index Dashboard - Hackathon", layout="wide")
...
if uploaded_file is None:
    st.warning("Upload OHI file (e.g. OHI_final_formatted_scores_2020-10-01.csv)")
    st.stop()
...
if not os.path.exists("trained_model.pkl"):
    st.warning("No trained model found. Please train the AI model first.")
else:
